...
public class DBUtil {
    		 ...
    		 // Class.forName(driver);
    		  ...
    		  if(connection!=null)
    			...
    			//  System.out.println("connection Obtained!");
    			  ...
    			  throw new com.cg.jdbc.exception.JDBCException("sorry!!! Something went wrong"
      			  		+ " with the connection");
    		  }
    	  }catch(Exception e) {
     ...
     //method for loading property file 
      private static Properties loadProp() throws JDBCException {
    	  Properties props = System.getProperties();
    	  String userDir= props.getProperty("user.dir")+"/src/main/resources/";
...
//method for closing the connection
	public static void closeConnection() throws JDBCException {
    	  try {
    		  if(connection !=null) {
    			  connection.close();
